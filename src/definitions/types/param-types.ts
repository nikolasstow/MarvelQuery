 ...
 * |------------------|----------|-------------------------------------------------------------------------------------
 * | `modifiedSince`  | `Date`   | Only return resources created or changed since the specified date. (e.g. 'YYYY-MM-DD', JavaScript Date object).
 ...
 * | `comics`         | `IDList`          | Return only characters which appear in the specified comics.
 * | `series`         | `IDList`          | Return only characters which appear in the specified series.
 * | `events`         | `IDList`          | Return only characters which appear in the specified events.
 * | `stories`        | `IDList`          | Return only characters which appear in the specified stories.
 ...
 * | `modifiedSince`  | `Date`            | Only return characters created or changed since the specified date. (e.g. 'YYYY-MM-DD', JavaScript Date object).
 * | `limit`          | `number`          | Limit the result set to the specified number of resources.
 * | `offset`         | `number`          | Skip the specified number of resources in the result set.
 */
 ...
 * | `creators`          | `IDList`                                                | Return only issues containing the specified creators (accepts id or array of ids).
 * | `series`            | `IDList`                                                | Return only issues in the specified series (accepts id or array of ids).
 * | `events`            | `IDList`                                                | Return only issues in the specified events (accepts id or array of ids).
 * | `stories`           | `IDList`                                                | Return only issues in the specified stories (accepts id or array of ids).
 * | `sharedAppearances` | `IDList`                                                | Return only issues in which the specified characters appear together (e.g. issues in which both Spider-Man and Gamora appear).
 * | `collaborators`     | `IDList`                                                | Return only issues in which the specified creators worked together (for example in which both Brian Bendis and Stan Lee did work).
 ...
 * | `modifiedSince`     | `Date`                                                  | Only return resources created or changed since the specified date. (Accepts various date formats; e.g. 'YYYY-MM-DD', JavaScript Date object).
 * | `limit`             | `number`                                                | Limit the result set to the specified number of resources.
 * | `offset`            | `number`                                                | Skip the specified number of resources in the result set.
 */
 ...
 * | `comics`               | `IDList`                                   | Return only creators who worked on in the specified comics (accepts id or array of ids).
 * | `series`               | `IDList`                                   | Return only creators who worked on the specified series (accepts id or array of ids).
 * | `events`               | `IDList`                                   | Return only creators who worked on comics that took place in the specified events (accepts id or array of ids).
 * | `stories`              | `IDList`                                   | Return only creators who worked on the specified stories (accepts id or array of ids).
 ...
 * | `creators`       | `IDList`                      | Return only events which feature work by the specified creators (accepts id or array of ids).
 * | `characters`     | `IDList`                      | Return only events which feature the specified characters (accepts id or array of ids).
 * | `series`         | `IDList`                      | Return only events which are part of the specified series (accepts id or array of ids).
 * | `comics`         | `IDList`                      | Return only events which take place in the specified comics (accepts id or array of ids).
 * | `stories`        | `IDList`                      | Return only events which take place in the specified stories (accepts id or array of ids).
 ...
 * | `comics`          | `IDList`                                    | Return only series which contain the specified comics (accepts id or array of ids).
 * | `stories`         | `IDList`                                    | Return only series which contain the specified stories (accepts id or array of ids).
 * | `events`          | `IDList`                                    | Return only series which have comics that take place during the specified events (accepts id or array of ids).
 * | `creators`        | `IDList`                                    | Return only series which feature work by the specified creators (accepts id or array of ids).
 * | `characters`      | `IDList`                                    | Return only series which feature the specified characters (accepts id or array of ids).
